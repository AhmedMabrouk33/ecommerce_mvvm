    ...
    List<Map<String, dynamic>> productsJson = [
      {
        ...
        "category": "Men",
        "image":
            "https://cdn-fsly.yottaa.net/596fc2e932f01c02ab33ec55/shop.samsonite.com/v~4b.7e/dw/image/v2/BBZB_PRD/on/demandware.static/-/Sites-product-catalog/default/dwd61542c1/collections/_samsonite/Novex/500x500/663431261_BP.jpg?sw=912&sh=912&yocs=F_J_",
      ...
      },
      {
        ...
        "price": 15.99,
        "details":
            "The color could be slightly different between on the screen and in practice. / Please note that body builds vary by person, therefore, detailed size information should be reviewed below on the product details.",
        "category": "Men",
